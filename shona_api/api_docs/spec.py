            ...
            reverse("analyze"): {
                "post": {
                    ...
                    "description": (
                        ...
                        "concord or the reflexive zvi prefix), bounded present "
                        "positive/negative verb forms, and imperative forms: "
                        "positive bare stems, the plural -i suffix (the attested "
                        "Manyika -nyi spelling analyzes as a variant), the prothetic "
                        "i- for monosyllabic radicals, singular object-marked "
                        "imperatives ending in -e, and negative usa-/musa- commands "
                        "with the Zezuru -e terminal generated and the attested -a "
                        "spelling analyzed as a dialect variant. Verb extensions "
                        "apply under height harmony and reversive vowel copy (see "
                        "the verbal extension rule cards). Ambiguous forms return "
                        "competing readings (no-object, object-concord, "
                        "reflexive-zvi, imperative), deduplicated and ordered "
                        "deterministically; imperative addressee information is "
                        "reported in a dedicated addressee slot, never as a finite "
                        "subject prefix. The imperative plural with an object "
                        "concord and imperative readings of divergent stems "
                        "(-ti/-nzi) and the defective pro-verb -na are excluded "
                        "on both generation and analysis, recorded with "
                        "deferred_imperative_plural_object and "
                        "excluded_divergent_stem_imperative future lanes. "
                        "Derivations whose per-lemma distribution "
                        "is not source-verified (causative -idz-/-its-, short "
                        "reversive) are excluded from inferred analyses; surfaces "
                        "resolve only as their own reviewed lemmas. The serving "
                        "release must declare the implemented morphology rules "
                        "version, otherwise the endpoint returns 503 "
            ...
            reverse("generate"): {
                "post": {
                    ...
                    "description": (
                        ...
                        "optional object concord or reflexive zvi), bounded "
                        "present positive/negative verb forms, and imperative "
                        "forms from a reviewed verb-stem lemma. Imperatives use "
                        "generation_type imperative with number (singular/plural) "
                        "and polarity: the positive singular is the bare stem "
                        "(prothetic i- for monosyllabic radicals), the positive "
                        "plural adds -i, the singular object-marked imperative is "
                        "object_concord + stem + -e, and negative commands are "
                        "usa-/musa- + [object_concord] + stem + -e (the attested "
                        "-a spelling is analyzed, never generated). Verb "
                        "extensions (passive, causative, applicative, neuter, "
                        "reciprocal, reversive, repetitive) apply with strict "
                        "style, order, and combination validation. Each branch "
                        "accepts only its documented feature fields and rejects "
                        "anything else with 422 GENERATION_UNSUPPORTED; deferred "
                        "combinations (plural with an object concord, reflexive "
                        "imperatives, unwitnessed a-vowel boundaries) return "
                        "structured deferred_pending_evidence refusals, mirrored "
                        "by inferred analysis with deferred_imperative_plural_object "
                        "and excluded_divergent_stem_imperative lanes. Extension "
                        ...
                        "derivations from its inferred analyses. The serving "
                        "release must declare the implemented morphology rules "
                        "version, otherwise the endpoint returns 503 "
                        "MORPHOLOGY_RULES_VERSION_UNSUPPORTED."
                    ),
